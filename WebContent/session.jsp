	  	...
	  	<div class="row d-flex justify-content-center pt-2">
		  	<div class="col-sm">
				<div class="card border-success mb-3">
				  <div class="card-header bg-transparent border-success">Session Details</div>
			...
			<div class="col-sm">
				<a href="session-invalid.jsp" class="btn btn-primary mr-2">Invalidate Session</a>
				<a href="session-add.jsp" class="btn btn-primary mr-2">Add item</a>
			</div>
		</div>	
  	</div>
