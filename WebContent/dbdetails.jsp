<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.util.*,net.javaguides.jsp.jdbc.database.*"%>
<!doctype html>
<html lang="en">
<head>
	  ...
	  <div class="row pt-2">
	  	<jsp:useBean id="employee"
			...
			<%
				...
				if (status > 0) {
					out.print("<div class='alert alert-success' role='alert'>You are successfully registered</div>");
				}
			%>
	  </div>
  	</div>
